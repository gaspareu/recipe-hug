...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Chat area */}
      <div className="flex-1 flex min-h-0 w-full max-w-3xl mx-auto pt-16 pr-[calc(var(--bookmark-rail-width)+env(safe-area-inset-right))]">
        <ChatInterface
          messages={messages}
      ...
      <AppBookmarkRail viewportHeight="app" />
