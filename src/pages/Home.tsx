...
export default function Home() {
  ...
  const { messages, isStreaming, sendMessage, resetChat } = useHomeChat();
  ...
  const quickSuggestions = [
    { icon: '🔍', text: 'Chercher une recette de poulet' },
    { icon: '✨', text: 'Crée-moi une recette de tarte' },
    { icon: '📖', text: 'Voir toutes mes recettes' },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <h1 className="text-xl font-semibold text-primary">Chef Michel</h1>
