...
export function CulinaryPreferencesContent() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Collapsible open={openSections.style} onOpenChange={() => toggleSection('style')}>
        ...
        <CollapsibleContent className="pt-2 space-y-4 px-1">
          <div className="space-y-2">
            <Label>Cuisines préférées</Label>
            <TagInput
          ...
          <div className="space-y-2">
            ...
            <TagInput
              ...
              placeholder="Ex: sauté, braisé, pâtisserie..."
            />
          </div>
          <div className="space-y-2">
            <Label>Niveau de difficulté préféré</Label>
            <Select
              value={prefs.culinary_style.preferred_difficulty || ''}
              onValueChange={(value) => 
                updateLocalPrefs('culinary_style', 'preferred_difficulty', (value as 'facile' | 'moyen' | 'difficile') || null)
              }
            >
              <SelectTrigger>
